...
public class GestaoVeiculosApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Condominio cond2 = new Condominio (2L, "Parque Uba", false, end1);
		...
		UnidadeHabitacional un1 =  new UnidadeHabitacional(1L, "Apto 501", "5B", true);
		...
		Morador m3 = new Morador(3L, "douglasdom", "dou@1989", false, false, "Douglas Domingues", "086.210.317-86", data,  listaTelefones, cond2,  unidades);
